-- =============================================================
-- Schéma BDD — API journaux (MLD) — IONOS compatible
-- =============================================================
-- Ce fichier n'exécute PAS CREATE DATABASE / USE (droits souvent absents en mutualisé).
-- 1) Créez d'abord la base dans le panneau IONOS.
-- 2) Dans phpMyAdmin, sélectionnez cette base (menu gauche) AVANT d'importer ce fichier.
-- 3) Collation conseillée : utf8mb4_unicode_520_ci (fallback: utf8mb4_unicode_ci).
-- =============================================================
...
-- Partitionnement: à activer plus tard avec ALTER TABLE (compte admin requis).
-- La PK devra inclure event_ts pour être compatible (ex: PRIMARY KEY(id_log, event_ts)).
...
CREATE TABLE IF NOT EXISTS alerte_regle (
  ...
  condition_dsl  VARCHAR(512) NOT NULL,
...
CREATE TABLE IF NOT EXISTS api_key (
  ...
  cle_pub        VARCHAR(64) NOT NULL UNIQUE,
...
-- Rétention enrichie (description + icône)
